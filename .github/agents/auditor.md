...
| Criterion 1 | `path/to/file.ts#L10` | `test-file.test.ts#L20` | ✅ |

| Criterion 2 | `path/to/file.ts#L20` | Missing | ❌ |

| Edge case 1 | `path/to/file.ts#L30` | `test-file.test.ts#L30` | ✅ |
...
- **NO CODE REVIEW** - Don't comment on code quality (`@code-reviewer` handles this)
...
- Mark in 🟡 Concerns section: "@test-engineer - [Coverage gap]" or "@code-reviewer - [Quality issue]"
...
- Mark in 🔴 Blockers section: "@code-reviewer - [Quality blocker]"
- `@code-reviewer` addresses quality issues
...
- "Should this code be refactored?" → **Escalate to: `@code-reviewer`**