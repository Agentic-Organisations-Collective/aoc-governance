...
- [Finding]: `path/to/file.ts#L10` - [Specific issue]
- [Finding]: `path/to/file.ts#L25` - [Specific issue]

### 🟡 Concerns (Should address)

- [Finding]: `path/to/file.ts#L40` - [Specific issue]
- [Finding]: `path/to/file.ts#L55` - [Specific issue]

### 🟢 Suggestions (Next refactor)

- [Finding]: `path/to/file.ts#L70` - [Specific issue]
...
- Developer fixes the issue or `@architect` updates architecture.md
...
- `@requirements-engineer` clarifies if the criterion is in scope or was misunderstood
- Developer implements or requirement is adjusted

**When unclear if code meets requirements:**

- Mark in 🟡 Concerns section: "@requirements-auditor - [Coverage question]"
- `@requirements-auditor` verifies requirements fulfillment during validation phase
